    ...
    return (
        <div>
          <h1>CONDITIONS GÉNÉRALES</h1>
            ...
            <br />
            <p>
                Ce site appartient et est géré par FitnessLife
            <br/>
            ...
            <p>
            Tout contenu publié et mis à disposition sur ce site est la propriété de FitnessLife
             et de ses créateurs. Cela comprend, mais n’est pas limité aux images, textes, logos, documents, fichiers téléchargeables et tout ce qui contribue à la composition de ce site.
            </p>
            <h2>Limitation de responsabilité</h2>
            <p>
            Biomir ou l’un de ses employés sera tenu responsable de tout problème découlant de ce site. Néanmoins, FitnessLife et ses employés ne seront pas tenus responsables de tout problème découlant de toute utilisation irrégulière de ce site.
            </p>
            <h2>Indemnité</h2>
            <p>
            En tant qu’utilisateur, vous indemnisez par les présentes FitnessLife de toute responsabilité, de tout coût, de toute cause d’action, de tout dommage ou de toute dépense découlant de votre utilisation de ce site ou de votre violation de l’une des dispositions énoncées dans le présent document.
            </p>
            ...
            <h2>Divisibilité</h2>
            <p>
            Si, à tout moment, l’une des dispositions énoncées dans le présent document est jugée incompatible ou invalide en vertu des lois applicables, ces dispositions seront considérées comme nulles et seront retirées du présent document. Toutes les autres dispositions ne seront pas touchées par les lois et le este du document sera toujours considéré comme valide.
            </p>
            <h2>Modifications</h2>
            <p>
            ...
            +33 6 56 56 65
            <br />
            fitnesslife@gmail.com
            <br />
            2 rue Jacques Lo Lille
            <br />
            Date d'entrée en vigueur : le 19juin 2022.
            </p>
            </div>
          </p>
